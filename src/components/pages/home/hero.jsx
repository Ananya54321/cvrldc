...
const Hero = () => {
  return (
    <div className="p-16 lg:p-48 flex items-center justify-center relative overflow-hidden">
      <Image
        src={homebg}
        alt="homebg"
        objectFit="cover"
      ...
      <div className="z-10 text-primary  text-center px-4 fade-up max-w-max mx-auto">
        <h1 className="text-5xl lg:text-7xl font-bold mb-8 titlefont ">
          Literary and Debate Club
        </h1>
        <p className="text-xl lg:text-3xl  text-cream max-w-5xl mx-auto mb-12  leading-relaxed">
