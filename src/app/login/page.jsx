  ...
  return (
    <div className="bg-ternary min-h-screen py-12 flex justify-center px-4">
      <div className="w-full md:w-[80%]">
        ...
        <div className="flex bg-accent gap-12 justify-between">
          <div className="bg-[#2c1810] md:w-[50%] rounded-2xl shadow-2xl p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="text-[#e6bc84] text-sm font-medium">
                  Username
                </label>
            ...
            <div className="mt-6 text-center">
              <p className="text-[#f5e6d3]/70 text-sm">
                ...
                <a
                  href="/register"
                  className="text-[#e6bc84] hover:text-[#e6bc84]/80">
                  Create one
                </a>
              </p>
            </div>
